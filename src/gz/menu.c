...
void menu_set_cxoffset(struct menu* menu, int cxoffset) { menu->cxoffset = cxoffset; }
...
void menu_set_cyoffset(struct menu* menu, int cyoffset) { menu->cyoffset = cyoffset; }
...
void menu_set_pxoffset(struct menu* menu, int pxoffset) { menu->pxoffset = pxoffset; }
...
void menu_set_pyoffset(struct menu* menu, int pyoffset) { menu->pyoffset = pyoffset; }
...
void menu_set_cell_width(struct menu* menu, int cell_width) { menu->cell_width = cell_width; }
...
void menu_set_cell_height(struct menu* menu, int cell_height) { menu->cell_height = cell_height; }
...
void menu_set_font(struct menu* menu, struct gfx_font* font) { menu->font = font; }
...
void menu_set_alpha(struct menu* menu, float alpha) { menu->alpha = alpha; }
...
void menu_item_enable(struct menu_item* item) { item->enabled = 1; }
...
int menu_item_screen_x(struct menu_item* item) { return menu_cell_screen_x(item->owner, item->x) + item->pxoffset; }

int menu_item_screen_y(struct menu_item* item) { return menu_cell_screen_y(item->owner, item->y) + item->pyoffset; }
