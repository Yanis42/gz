...
float vec3f_dot(z64_xyzf_t* a, z64_xyzf_t* b) { return a->x * b->x + a->y * b->y + a->z * b->z; }

float vec3f_mag(z64_xyzf_t* a) { return sqrtf(vec3f_dot(a, a)); }

float vec3f_cos(z64_xyzf_t* a, z64_xyzf_t* b) { return vec3f_dot(a, b) / vec3f_mag(a) / vec3f_mag(b); }

float vec3f_angle(z64_xyzf_t* a, z64_xyzf_t* b) { return acosf(vec3f_cos(a, b)); }

z64_xyzf_t* vec3f_norm(z64_xyzf_t* r, z64_xyzf_t* a) { return vec3f_scale(r, a, 1.f / vec3f_mag(a)); }
