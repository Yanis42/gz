...
int bind_get_component(uint16_t bind, int index) { return (bind >> (4 * index)) & 0x000F; }
...
uint16_t input_z_pad(void) { return z64_input_direct.raw.pad | input_sch_pad; }

int8_t input_x(void) { return joy_x; }

int8_t input_y(void) { return joy_y; }
...
void input_bind_set_disable(int index, _Bool value) { bind_disable[index] = value; }

void input_bind_set_override(int index, _Bool value) { bind_override[index] = value; }
