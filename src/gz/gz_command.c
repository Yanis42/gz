...
void command_levitate(void) { z64_link.common.vel_1.y = 6.34375f; }

void command_fall(void) { z64_link.common.pos_1.y = -4096.f; }

void command_turbo(void) { z64_link.linear_vel = 27.f; }
...
void command_fileselect(void) { zu_execute_filemenu(); }
...
void command_timer(void) { gz.timer_active = !gz.timer_active; }
...
void command_reset(void) { gz.reset_flag = 1; }
