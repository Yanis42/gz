...
static void accept_proc(struct menu_item* item, void* data) { return_path(gf_name->text); }

static void clear_proc(struct menu_item* item, void* data) { set_name(NULL, 1); }
