...
static int col_view_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
        ...
        _Bool state = gz.col_view_state == COLVIEW_START || gz.col_view_state == COLVIEW_ACTIVE ||
                      gz.col_view_state == COLVIEW_RESTART || gz.col_view_state == COLVIEW_RESTARTING;
...
static int holl_view_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
        ...
        _Bool state = gz.holl_view_state == HOLLVIEW_START || gz.holl_view_state == HOLLVIEW_ACTIVE;
        if (menu_checkbox_get(item) != state) {
            menu_checkbox_set(item, state);
        }
    }
...
static int holl_view_xlu_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int holl_view_all_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int col_view_mode_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
...
static int col_view_xlu_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int col_view_water_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int col_view_wfc_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int col_view_line_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int col_view_shade_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int col_view_rd_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int col_view_upd_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int hit_view_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
        ...
        _Bool state = gz.hit_view_state == HITVIEW_START || gz.hit_view_state == HITVIEW_ACTIVE;
        if (menu_checkbox_get(item) != state) {
            menu_checkbox_set(item, state);
        }
    }
...
static int hit_view_at_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int hit_view_ac_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int hit_view_oc_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int hit_view_xlu_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int hit_view_shade_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int path_view_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
        ...
        _Bool state = gz.path_view_state == PATHVIEW_START || gz.path_view_state == PATHVIEW_ACTIVE ||
                      gz.path_view_state == PATHVIEW_RESTART || gz.path_view_state == PATHVIEW_RESTARTING;
        if (menu_checkbox_get(item) != state) {
            menu_checkbox_set(item, state);
        }
    }
...
static int path_view_xlu_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int path_view_points_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static int path_view_lines_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
...
static void set_cam_input_mask(void) {
    if (gz.free_cam && !gz.lock_cam) {
        gz_set_input_mask(BUTTON_C_RIGHT | BUTTON_C_LEFT | BUTTON_C_DOWN | BUTTON_C_UP | BUTTON_Z | BUTTON_L, 0xFF,
                          0xFF);
    } else {
...
static int cam_mode_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
...
static int hide_rooms_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
        gz.hide_rooms = 1;
    } else if (reason == MENU_CALLBACK_SWITCH_OFF) {
        gz.hide_rooms = 0;
...
static int hide_actors_proc(struct menu_item* item, enum menu_callback_reason reason, void* data) {
    if (reason == MENU_CALLBACK_SWITCH_ON) {
        gz.hide_actors = 1;
    } else if (reason == MENU_CALLBACK_SWITCH_OFF) {
        gz.hide_actors = 0;
...
struct menu* gz_scene_menu(void) {
    ...
    menu_add_watch(&menu, 18, 9, (uint32_t)&settings->teleport_slot, WATCH_TYPE_U8);
    ...
    menu_add_watch(&menu, 16, 10, (uint32_t)&z64_game.scene_index, WATCH_TYPE_U16);
    menu_add_static(&menu, 0, 11, "current room", 0xC0C0C0);
    menu_add_watch(&menu, 16, 11, (uint32_t)&z64_game.room_ctxt.rooms[0].index, WATCH_TYPE_U8);
    ...
    menu_add_option(&collision, 16, 2,
                    "decal\0"
                    "surface\0",
