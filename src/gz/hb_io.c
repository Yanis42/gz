...
static uint64_t hb_get_timebase64(void) { return ((uint64_t)hb_regs.timebase_hi << 32) | hb_regs.timebase_lo; }

static unsigned int clock_ticks(void) { return hb_regs.timebase_lo; }

static unsigned int clock_freq(void) { return HB_TIMEBASE_FREQ; }
