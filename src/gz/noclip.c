...
static void noclip_update(z64_link_t* player, z64_game_t* global_ctx) {
    ...
    if (input_held & (BUTTON_D_UP | BUTTON_D_DOWN | BUTTON_D_LEFT | BUTTON_D_RIGHT)) {
...
void gz_noclip_start(void) {
    ...
    input_reserve(BUTTON_D_UP | BUTTON_D_DOWN | BUTTON_D_LEFT | BUTTON_D_RIGHT | BUTTON_A | BUTTON_B | BUTTON_R);
...
void gz_noclip_stop(void) {
    ...
    input_free(BUTTON_D_UP | BUTTON_D_DOWN | BUTTON_D_LEFT | BUTTON_D_RIGHT | BUTTON_A | BUTTON_B | BUTTON_R);
