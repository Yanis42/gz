...
static void vtxn_f2l(Vtx* r, z64_xyzf_t* v) {
    *r = gdSPDefVtxN(floorf(0.5f + v->x * 128.f), floorf(0.5f + v->y * 128.f), floorf(0.5f + v->z * 128.f), 0, 0,
                     v->x * 127.f, v->y * 127.f, v->z * 127.f, 0xFF);
}

static void draw_line(Gfx** p_gfx_p, Gfx** p_gfx_d, z64_xyz_t* v1, z64_xyz_t* v2) {
    Vtx v[2] = {
...
static void tri_norm(z64_xyzf_t* v1, z64_xyzf_t* v2, z64_xyzf_t* v3, z64_xyzf_t* norm) {
...
static void draw_tri(Gfx** p_gfx_p, Gfx** p_gfx_d, z64_xyzf_t* v1, z64_xyzf_t* v2, z64_xyzf_t* v3) {
    z64_xyzf_t norm;
...
static void draw_quad(Gfx** p_gfx_p, Gfx** p_gfx_d, z64_xyzf_t* v1, z64_xyzf_t* v2, z64_xyzf_t* v3, z64_xyzf_t* v4) {
    z64_xyzf_t norm;
...
static void draw_cuboid(Gfx** p_gfx_p, Gfx** p_gfx_d, z64_xyzf_t* v_min, z64_xyzf_t* v_max) {
    static Vtx cube_vtx[24] = {
        gdSPDefVtxN(-128, -128, -128, 0, 0, -127, 0, 0, 0xFF), gdSPDefVtxN(-128, 128, -128, 0, 0, -127, 0, 0, 0xFF),
        gdSPDefVtxN(-128, 128, 128, 0, 0, -127, 0, 0, 0xFF),   gdSPDefVtxN(-128, -128, 128, 0, 0, -127, 0, 0, 0xFF),

        gdSPDefVtxN(128, 128, -128, 0, 0, 127, 0, 0, 0xFF),    gdSPDefVtxN(128, -128, -128, 0, 0, 127, 0, 0, 0xFF),
        gdSPDefVtxN(128, -128, 128, 0, 0, 127, 0, 0, 0xFF),    gdSPDefVtxN(128, 128, 128, 0, 0, 127, 0, 0, 0xFF),

        gdSPDefVtxN(-128, -128, -128, 0, 0, 0, -127, 0, 0xFF), gdSPDefVtxN(-128, -128, 128, 0, 0, 0, -127, 0, 0xFF),
        gdSPDefVtxN(128, -128, 128, 0, 0, 0, -127, 0, 0xFF),   gdSPDefVtxN(128, -128, -128, 0, 0, 0, -127, 0, 0xFF),

        gdSPDefVtxN(128, 128, -128, 0, 0, 0, 127, 0, 0xFF),    gdSPDefVtxN(128, 128, 128, 0, 0, 0, 127, 0, 0xFF),
        gdSPDefVtxN(-128, 128, 128, 0, 0, 0, 127, 0, 0xFF),    gdSPDefVtxN(-128, 128, -128, 0, 0, 0, 127, 0, 0xFF),

        gdSPDefVtxN(-128, -128, -128, 0, 0, 0, 0, -127, 0xFF), gdSPDefVtxN(128, -128, -128, 0, 0, 0, 0, -127, 0xFF),
        gdSPDefVtxN(128, 128, -128, 0, 0, 0, 0, -127, 0xFF),   gdSPDefVtxN(-128, 128, -128, 0, 0, 0, 0, -127, 0xFF),
    ...
    gSPMatrix((*p_gfx_p)++, gDisplayListData(p_gfx_d, m), G_MTX_MODELVIEW | G_MTX_MUL | G_MTX_PUSH);
    gSPDisplayList((*p_gfx_p)++, cube_gfx);
    gSPPopMatrix((*p_gfx_p)++, G_MTX_MODELVIEW);
}

static void draw_cyl(Gfx** p_gfx_p, Gfx** p_gfx_d, float x, float y, float z, int radius, int height) {
...
#define CYL_DIVS 12
        ...
        for (int i = 0; i < CYL_DIVS; ++i) {
            ...
            cyl_vtx[2 + i * 2 + 0] = gdSPDefVtxN(vtx_x, 0, vtx_z, 0, 0, norm_x, 0, norm_z, 0xFF);
            cyl_vtx[2 + i * 2 + 1] = gdSPDefVtxN(vtx_x, 128, vtx_z, 0, 0, norm_x, 0, norm_z, 0xFF);
        }
...
static void draw_ico_sphere(Gfx** p_gfx_p, Gfx** p_gfx_d, float x, float y, float z, float radius) {
    ...
    if (!p_sph_gfx) {
        ...
        for (int i = 0; i < 5; ++i) {
            int v[24] = {
                r0_i + (i * r0_m + 0) % r0_n, r1_i + (i * r1_m + 0) % r1_n, r1_i + (i * r1_m + 1) % r1_n,

                r1_i + (i * r1_m + 0) % r1_n, r2_i + (i * r2_m + 0) % r2_n, r2_i + (i * r2_m + 1) % r2_n,

                r1_i + (i * r1_m + 0) % r1_n, r2_i + (i * r2_m + 1) % r2_n, r1_i + (i * r1_m + 1) % r1_n,

                r1_i + (i * r1_m + 1) % r1_n, r2_i + (i * r2_m + 1) % r2_n, r2_i + (i * r2_m + 2) % r2_n,

                r2_i + (i * r2_m + 0) % r2_n, r3_i + (i * r3_m + 0) % r3_n, r2_i + (i * r2_m + 1) % r2_n,

                r2_i + (i * r2_m + 1) % r2_n, r3_i + (i * r3_m + 0) % r3_n, r3_i + (i * r3_m + 1) % r3_n,

                r2_i + (i * r2_m + 1) % r2_n, r3_i + (i * r3_m + 1) % r3_n, r2_i + (i * r2_m + 2) % r2_n,

                r2_i + (i * r2_m + 2) % r2_n, r3_i + (i * r3_m + 1) % r3_n, r3_i + (i * r3_m + 2) % r3_n,
            };
        ...
        for (int i = 0; i < 5; ++i) {
            int v[24] = {
                r3_i + (i * r3_m + 1) % r3_n, r4_i + (i * r4_m + 0) % r4_n, r4_i + (i * r4_m + 1) % r4_n,

                r3_i + (i * r3_m + 1) % r3_n, r4_i + (i * r4_m + 1) % r4_n, r3_i + (i * r3_m + 2) % r3_n,

                r3_i + (i * r3_m + 2) % r3_n, r4_i + (i * r4_m + 1) % r4_n, r4_i + (i * r4_m + 2) % r4_n,

                r3_i + (i * r3_m + 2) % r3_n, r4_i + (i * r4_m + 2) % r4_n, r3_i + (i * r3_m + 3) % r3_n,

                r4_i + (i * r4_m + 0) % r4_n, r5_i + (i * r5_m + 0) % r5_n, r4_i + (i * r4_m + 1) % r4_n,

                r4_i + (i * r4_m + 1) % r4_n, r5_i + (i * r5_m + 0) % r5_n, r5_i + (i * r5_m + 1) % r5_n,

                r4_i + (i * r4_m + 1) % r4_n, r5_i + (i * r5_m + 1) % r5_n, r4_i + (i * r4_m + 2) % r4_n,

                r5_i + (i * r5_m + 0) % r5_n, r6_i + (i * r6_m + 0) % r6_n, r5_i + (i * r5_m + 1) % r5_n,
            };
            gSP2Triangles(sph_gfx_p++, v[0], v[1], v[2], 0, v[3], v[4], v[5], 0);
            gSP2Triangles(sph_gfx_p++, v[6], v[7], v[8], 0, v[9], v[10], v[11], 0);
            gSP2Triangles(sph_gfx_p++, v[12], v[13], v[14], 0, v[15], v[16], v[17], 0);
...
static void poly_writer_flush(poly_writer_t* writer) {
    ...
    if (writer->n_vtx % 6 != 0) {
        *writer->tri_cmd = gsSP1Triangle(writer->n_vtx - 3, writer->n_vtx - 2, writer->n_vtx - 1, 0);
    }
    writer->tri_cmd = NULL;
...
static void poly_writer_finish(poly_writer_t* writer, Gfx** p_gfx_p, Gfx** p_gfx_d) {
...
static void poly_writer_add(poly_writer_t* writer, Vtx (*v)[3], uint32_t color) {
    ...
    if (writer->last_color != color) {
        gDPSetPrimColor(writer->gfx_p++, 0, 0, (color >> 24) & 0xFF, (color >> 16) & 0xFF, (color >> 8) & 0xFF,
                        (color >> 0) & 0xFF);
        if (writer->n_vtx % 6 != 0) {
            *writer->tri_cmd = gsSP1Triangle(writer->n_vtx - 3, writer->n_vtx - 2, writer->n_vtx - 1, 0);
            writer->tri_cmd = writer->gfx_p++;
            *writer->tri_cmd = gsSP1Triangle(writer->n_vtx + 0, writer->n_vtx + 1, writer->n_vtx + 2, 0);
        }
    ...
    if (writer->n_vtx % 6 == 0) {
        writer->tri_cmd = writer->gfx_p++;
        *writer->tri_cmd = gsSP2Triangles(writer->n_vtx + 0, writer->n_vtx + 1, writer->n_vtx + 2, 0, writer->n_vtx + 3,
                                          writer->n_vtx + 4, writer->n_vtx + 5, 0);
    }
...
static void line_writer_finish(line_writer_t* writer, Gfx** p_gfx_p, Gfx** p_gfx_d) {
...
static void do_poly_list(poly_writer_t* poly_writer, line_writer_t* line_writer, struct vector* line_set,
                         z64_xyz_t* vtx_list, z64_col_poly_t* poly_list, z64_col_type_t* type_list, int n_poly,
                         _Bool rd, _Bool wfc) {
...
#undef COLPOLY_SNORMAL
            ...
            if (!skip) {
                Vtx v[3] = {
                    gdSPDefVtxN(va->x, va->y, va->z, 0, 0, poly->norm.x / 0x100, poly->norm.y / 0x100,
                                poly->norm.z / 0x100, 0xFF),
                    gdSPDefVtxN(vb->x, vb->y, vb->z, 0, 0, poly->norm.x / 0x100, poly->norm.y / 0x100,
                                poly->norm.z / 0x100, 0xFF),
                    gdSPDefVtxN(vc->x, vc->y, vc->z, 0, 0, poly->norm.x / 0x100, poly->norm.y / 0x100,
                                poly->norm.z / 0x100, 0xFF),
                };
        ...
        if (line_writer) {
            ...
            if (line_set) {
                for (int i = 0; i < line_set->size; ++i) {
                    ...
                    if ((l->va == lab.va && l->vb == lab.vb) || (l->va == lab.vb && l->vb == lab.va)) {
                        ab = 0;
                    }
                    if ((l->va == lbc.va && l->vb == lbc.vb) || (l->va == lbc.vb && l->vb == lbc.va)) {
                        bc = 0;
                    }
                    if ((l->va == lca.va && l->vb == lca.vb) || (l->va == lca.vb && l->vb == lca.va)) {
                        ca = 0;
                    }
                }
                if (ab) {
            ...
            int n_vtx = 0;
            if (ab || ca) {
                v[n_vtx++] = gdSPDefVtxC(va->x, va->y, va->z, 0, 0, 0x00, 0x00, 0x00, 0xFF);
            }
            if (ab || bc) {
                v[n_vtx++] = gdSPDefVtxC(vb->x, vb->y, vb->z, 0, 0, 0x00, 0x00, 0x00, 0xFF);
            }
            if (bc || ca) {
                v[n_vtx++] = gdSPDefVtxC(vc->x, vc->y, vc->z, 0, 0, 0x00, 0x00, 0x00, 0xFF);
            }
...
static void do_dyn_list(poly_writer_t* poly_writer, line_writer_t* line_writer, z64_col_hdr_t* col_hdr,
    ...
    while (list_idx != 0xFFFF) {
        ...
        do_poly_list(poly_writer, line_writer, NULL, col_ctxt->dyn_vtx, &col_ctxt->dyn_poly[list->poly_idx],
...
static void do_dyn_col(poly_writer_t* poly_writer, line_writer_t* line_writer, _Bool rd, _Bool wfc) {
    z64_col_ctxt_t* col_ctxt = &z64_game.col_ctxt;
    ...
    for (int i = 0; i < 50; ++i) {
        if (col_ctxt->dyn_flags[i].active) {
            ...
            do_dyn_list(poly_writer, line_writer, dyn_col->col_hdr, dyn_col->ceil_list_idx, rd, wfc);
            do_dyn_list(poly_writer, line_writer, dyn_col->col_hdr, dyn_col->wall_list_idx, rd, wfc);
            do_dyn_list(poly_writer, line_writer, dyn_col->col_hdr, dyn_col->floor_list_idx, rd, wfc);
        }
    }
}

static void do_waterbox_list(Gfx** p_gfx_p, Gfx** p_gfx_d, int n_waterboxes, z64_col_water_t* waterbox_list) {
    ...
    for (int i = 0; i < n_waterboxes; ++i) {
        ...
        if (w->flags.group == z64_game.room_ctxt.rooms[0].index ||
            w->flags.group == z64_game.room_ctxt.rooms[1].index || w->flags.group == 0x3F) {
...
static void init_poly_gfx(Gfx** p_gfx_p, Gfx** p_gfx_d, int mode, _Bool xlu, _Bool shade) {
    uint32_t rm;
    uint32_t blc1;
    uint32_t blc2;
    uint8_t alpha;
...
void gz_col_view(void) {
    ...
    _Bool enable = zu_in_game() && (z64_game.pause_ctxt.state < 2 ||
                                    (z64_game.pause_ctxt.state == 2 && z64_file.gameinfo->screenshot_state < 3));
    _Bool init = gz.col_view_state == COLVIEW_START || gz.col_view_state == COLVIEW_RESTARTING;

    /* restart if needed */
    if (enable && gz.col_view_state == COLVIEW_ACTIVE && settings->bits.col_view_upd &&
        (col_view_scene != z64_game.scene_index || col_view_water != settings->bits.col_view_water ||
         col_view_wfc != settings->bits.col_view_wfc || col_view_line != settings->bits.col_view_line ||
    ...
    if (enable && init) {
        ...
        do_poly_list(p_poly_writer, p_line_writer, &line_set, col_hdr->vtx, col_hdr->poly, col_hdr->type,
                     col_hdr->n_poly, col_view_rd, col_view_wfc);
    ...
    if (enable && (init || (active && settings->bits.col_view_upd))) {
        ...
        if (col_view_water) {
            ...
            do_waterbox_list(&dyn_poly_p, &dyn_poly_d, z64_game.col_ctxt.col_hdr->n_water,
                             z64_game.col_ctxt.col_hdr->water);

            for (int i = 0; i < 50; ++i) {
                if (z64_game.col_ctxt.dyn_flags[i].active) {
                    z64_dyn_col_t* dyn_col = &z64_game.col_ctxt.dyn_col[i];
                    do_waterbox_list(&dyn_poly_p, &dyn_poly_d, dyn_col->col_hdr->n_water, dyn_col->col_hdr->water);
                }
            }
            /*
    ...
    if (enable && active) {
        ...
        /* polys */
        init_poly_gfx(p_gfx_p, p_gfx_d, settings->bits.col_view_mode, settings->bits.col_view_xlu,
        ...
        if (col_view_line) {
            load_l3dex2(p_gfx_p);
            init_line_gfx(p_gfx_p, p_gfx_d, settings->bits.col_view_mode, settings->bits.col_view_xlu);
...
static void do_hitbox_list(Gfx** p_gfx_p, Gfx** p_gfx_d, int n_hit, z64_hit_t** hit_list, uint32_t color) {
    gDPSetPrimColor((*p_gfx_p)++, 0, 0, (color >> 16) & 0xFF, (color >> 8) & 0xFF, (color >> 0) & 0xFF, 0xFF);
        ...
        switch (hit->type) {
            case Z64_HIT_SPH_LIST: {
                ...
                for (int j = 0; j < hit_sph_list->n_ent; ++j) {
                    ...
                    draw_ico_sphere(p_gfx_p, p_gfx_d, ent->pos.x, ent->pos.y, ent->pos.z, radius);
                }
            ...
            case Z64_HIT_CYL: {
                ...
                draw_cyl(p_gfx_p, p_gfx_d, hit_cyl->pos.x, hit_cyl->pos.y + hit_cyl->y_offset, hit_cyl->pos.z, radius,
                         hit_cyl->height);
            ...
            case Z64_HIT_QUAD: {
                ...
                draw_quad(p_gfx_p, p_gfx_d, &hit_quad->v[0], &hit_quad->v[2], &hit_quad->v[3], &hit_quad->v[1]);
...
void gz_hit_view(void) {
    ...
    if (enable && gz.hit_view_state == HITVIEW_ACTIVE) {
        ...
        init_poly_gfx(&hit_gfx_p, &hit_gfx_d, SETTINGS_COLVIEW_SURFACE, settings->bits.hit_view_xlu,
                      settings->bits.hit_view_shade);

        if (settings->bits.hit_view_oc) {
            do_hitbox_list(&hit_gfx_p, &hit_gfx_d, z64_game.hit_ctxt.n_oc, z64_game.hit_ctxt.oc_list, 0xFFFFFF);
        }

        if (settings->bits.hit_view_ac) {
            do_hitbox_list(&hit_gfx_p, &hit_gfx_d, z64_game.hit_ctxt.n_ac, z64_game.hit_ctxt.ac_list, 0x0000FF);
        }

        if (settings->bits.hit_view_at) {
            do_hitbox_list(&hit_gfx_p, &hit_gfx_d, z64_game.hit_ctxt.n_at, z64_game.hit_ctxt.at_list, 0xFF0000);
        }
...
void gz_path_view(void) {
    ...
    _Bool init = gz.path_view_state == PATHVIEW_START || gz.path_view_state == PATHVIEW_RESTARTING;

    /* restart if needed */
    if (enable && gz.path_view_state == PATHVIEW_ACTIVE &&
        (path_view_points != settings->bits.path_view_points || path_view_lines != settings->bits.path_view_lines)) {
        ...
        if (path_view_points) {
            ...
            for (z64_path_t* path = z64_game.path_list; path_valid(path); ++path) {
                ...
                for (int i = 0; i < path->numpoints; ++i) {
                    ...
                    draw_ico_sphere(&poly_gfx_p, &poly_gfx_d, points[i].x, points[i].y, points[i].z, 18.f);
                }
            }
...
void gz_cull_view(void) {
    ...
    if (enable && gz.cull_view_state == CULLVIEW_ACTIVE) {
        ...
        init_poly_gfx(&cull_gfx_p, &cull_gfx_d, SETTINGS_COLVIEW_SURFACE, 1 /* xlu */, 0 /* shaded */);
...
void gz_holl_view(void) {
    ...
    if (enable && gz.holl_view_state == HOLLVIEW_ACTIVE) {
        ...
        init_poly_gfx(&holl_gfx_p, &holl_gfx_d, SETTINGS_COLVIEW_SURFACE, settings->bits.holl_view_xlu, 1);
...
#define HOLL_HALFWIDTH_X 100.0f
            ...
            switch (draw_type) {
                ...
                case HOLL_DRAW_TYPE_CUBOID_4:
                    ...
                    if (z64_game.room_ctxt.rooms[0].file != NULL && z64_game.room_ctxt.rooms[1].file != NULL) {
                        if (show_all) {
                ...
                case HOLL_DRAW_TYPE_CYL_2: {
                    ...
                    gDPSetPrimColor(holl_gfx_p++, 0, 0, 0x00, 0xFF, 0x00, 0xFF);
                    draw_cyl(&holl_gfx_p, &holl_gfx_d, actor->pos_2.x, actor->pos_2.y + offset, actor->pos_2.z,
                ...
                case HOLL_DRAW_TYPE_CYL_1: {
                    ...
                    gDPSetPrimColor(holl_gfx_p++, 0, 0, 0x00, 0xFF, 0x00, 0xFF);
                    draw_cyl(&holl_gfx_p, &holl_gfx_d, actor->pos_2.x, actor->pos_2.y + cyl_offset, actor->pos_2.z,
                             cyl_radius, cyl_height);
                    break;
                }
            }
